...
public interface ISqlReadScriptBuilder : ISqlScriptBuilder
{
    ...
    //ISqlReadScriptBuilder Select( ISelectBuilder selectBuilder );
    //ISqlReadScriptBuilder From( IFromBuilder fromBuilder );
    //ISqlReadScriptBuilder GroupBy( IGroupByBuilder groupByBuilder );
    //ISqlReadScriptBuilder OrderBy( IOrderByBuilder orderByBuilder );
